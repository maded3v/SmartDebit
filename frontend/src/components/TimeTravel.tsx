...
interface TimeTravelProps {
  // дополнительные классы — на случай, если виджет встраивается в разные места (топбар, отдельная карточка на дашборде и т.д.)
  className?: string
  // краткий вариант — без подписи «Виртуальная дата» (для топбара)
  compact?: boolean
}

// Виджет «Перемотки времени»
// Отображает текущую виртуальную дату и кнопки быстрого сдвига:
// +1 день, +10 дней, +30 дней, а также «Сбросить»
// При активной симуляции выделяется акцентным цветом, чтобы пользователь точно понимал — данные на странице сейчас рассчитаны не на сегодня
